sap.ui.define([
	...
	return Control.extend("org.fater.myinbox.control.TERadioQuestion", {
		...
		//	this.setProperty("valueState", 'None');
		console.log('Invalidate Radio Question');
		}
