...
sap.ui.define([
...
], function(Controller, formatter, utils, JSONModel, MessageBox, Dialog, Input, TextArea, Button, ButtonType, Text, RichTooltip,
	TETextQuestion,
	TETextAreaQuestion,
	...
	return Controller.extend("org.fater.myinbox.controller.Detail", {
		...
		__initFieldsVisibility: function(controller) {
			...
			var isSupplier = userRole === controller.getOwnerComponent().getModel("Types").getProperty("/userRoleTypes/SUPPLIER") || (
				isCommercialRef && isDoneByFater);
			var disableAll = userRole === controller.getOwnerComponent().getModel("Types").getProperty("/userRoleTypes/SUPPLIER") &&
				surveyStatus === this.getComponentModelProperty("Types", "/participationStatus/R");
			var fields = {};
			...
			controller.__addField(fields, tabKey, {
				"realtime_validate": false
			}, "supplier_doc_upload_email", isDoneByFater, isDoneByFater && isCommercialRef, isDoneByFater && isCommercialRef);
			controller.__addField(fields, tabKey, {
				"realtime_validate": false
			}, "supplier_doc_upload_form", isDoneByFater, isDoneByFater && isCommercialRef, isDoneByFater && isCommercialRef);
			...
			if (surveyType === controller.getOwnerComponent().getModel("Types").getProperty("/participationType/PRE_QUALIFICATION")) {
				...
				controller.__addField(fields, tabKey, null, "street_address", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);
				controller.__addField(fields, tabKey, null, "street_number", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);
				controller.__addField(fields, tabKey, null, "cap", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
					false : true);
				controller.__addField(fields, tabKey, null, "locality", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
					false : true);
				controller.__addField(fields, tabKey, null, "country", true);
				controller.__addField(fields, tabKey, null, "province", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
					false : true);
				controller.__addField(fields, tabKey, null, "telephone", true, !isSupplier || disableAll ? false : true);
				controller.__addField(fields, tabKey, null, "communication_preferred", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);
				controller.__addField(fields, tabKey, null, "fax", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
					false : true);
				controller.__addField(fields, tabKey, {
					"validation": {
						"email": true
					}
				}, "email", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ? false : true);
			}
			...
			controller.__addField(fields, tabKey, null, "contact_business_name", true, !isSupplier || disableAll ? false : true, !isSupplier ||
				disableAll ? false : true);
			controller.__addField(fields, tabKey, null, "contact_business_surname", true, !isSupplier || disableAll ? false : true, !isSupplier ||
				disableAll ? false : true);
			controller.__addField(fields, tabKey, {
				"validation": {
					"email": true
				}
			}, "contact_business_email", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ? false : true);
			...
			controller.__addField(fields, tabKey, null, "contact_oda_name", true, !isSupplier || disableAll ? false : true, !isSupplier ||
				disableAll ? false : false);
			controller.__addField(fields, tabKey, null, "contact_oda_surname", true, !isSupplier || disableAll ? false : true, !isSupplier ||
				disableAll ? false : false);
			controller.__addField(fields, tabKey, {
				"validation": {
					"email": true
				}
			}, "contact_oda_email", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ? false : false);

			controller.__addField(fields, tabKey, null, "contact_administration_name", true, !isSupplier || disableAll ? false : true, !
				isSupplier || disableAll ? false : false);
			controller.__addField(fields, tabKey, null, "contact_administration_surname", true, !isSupplier || disableAll ? false : true, !
				isSupplier || disableAll ? false : false);
			controller.__addField(fields, tabKey, {
				"validation": {
					"email": true
				}
			}, "contact_administration_email", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ? false : false);
			...
			if (supplierType === controller.getOwnerComponent().getModel("Types").getProperty("/supplierTypes/NATIONAL")) {
				...
				controller.__addField(fields, tabKey, null, "profession", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);
				controller.__addField(fields, tabKey, null, "gender", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
					false : true);
				controller.__addField(fields, tabKey, null, "birth_city", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);
				controller.__addField(fields, tabKey, null, "birth_date", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);
				controller.__addField(fields, tabKey, null, "withholding", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);
			}
			...
			if (surveyType !== controller.getOwnerComponent().getModel("Types").getProperty("/participationType/PRE_QUALIFICATION")) {
				...
				controller.__addField(fields, tabKey, null, "bank_name", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
					false : true);
				controller.__addField(fields, tabKey, null, "bank_address", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);
				controller.__addField(fields, tabKey, null, "backup_account", true, !isSupplier || disableAll ? false : true, !isSupplier ||
					disableAll ? false : true);

				if (supplierType === controller.getOwnerComponent().getModel("Types").getProperty("/supplierTypes/NATIONAL") || supplierType ===
					controller.getOwnerComponent().getModel("Types").getProperty("/supplierTypes/FREELANCER")) {
					...
					controller.__addField(fields, tabKey, null, "swift", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
						false : true);
					...
					}, "iban", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ? false : true);

				} else if (supplierType === controller.getOwnerComponent().getModel("Types").getProperty("/supplierTypes/CEE")) {
					controller.__addField(fields, tabKey, null, "branch", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
						false : true);
					controller.__addField(fields, tabKey, null, "branch_code", true, !isSupplier || disableAll ? false : true, !isSupplier ||
						disableAll ? false : true);
					controller.__addField(fields, tabKey, null, "swift", true, !isSupplier || disableAll ? false : true, !isSupplier || disableAll ?
						false : true);
			...
			// DB - FIX bug #081: Reset validazione
			...
			if (!this.isFromBack) {
				var mParameters = {
					...
					success: function(oData) {
						...
						if (isWelcomeVisible) {
							oView.byId("welcome_image").setSrc($.sap.getModulePath("org.fater.myinbox", "/img/faterspa.jpg"));
						}
						...
						var isCommercialRef = userId === controller.getView().getModel().getProperty("/CommercialRefId");
						var isSupplier = userRole === controller.getOwnerComponent().getModel("Types").getProperty("/userRoleTypes/SUPPLIER") || (
							isCommercialRef && doneByFater);
						var surveyStatus = controller.getView().getModel().getProperty("/Status");

						if ((isSupplier && (surveyStatus === controller.getComponentModelProperty("Types", "/participationStatus/ES") || surveyStatus ===
								controller.getComponentModelProperty("Types", "/participationStatus/EA"))) || (isCommercialRef && surveyStatus ===
								controller.getComponentModelProperty("Types", "/participationStatus/ER"))) {
						...
						//BEGIN FIX DB 30.06.2017 (Rilettura Ticket sempre)
						// Altrimenti al cambio di Questionario non vengono caricati i ticket relativi
				...
				var oData = this.getView().getModel("oDataModel").read("/" + id, mParameters);
		...
		onApproveButtonPress: function(oEvent) {
			//alert("Detail : onApproveButtonPress");
			...
			var dialog = new Dialog({
				...
				beginButton: new Button({
					...
					press: function() {
						...
						controller.updateParticipation(dialog, nextStatus, null, controller.getTranslation("approveSupplierDialogError"), function(
							oData, response) {
		...
		onCompleteButtonPress: function(oEvent) {
			...
			//alert("Detail : onCompleteButtonPress");
			...
			if (isDoneByFater && isCommercialRef) {
				...
				if (currentStatus === controller.getComponentModelProperty("Types", "/participationStatus/C") || currentStatus === controller.getComponentModelProperty(
						"Types", "/participationStatus/C1")
					//Aggiunta gestione passaggio dallo statoER (richiesta di chiarimento da parte del Resp. Commerciale) 
					|| currentStatus === controller.getComponentModelProperty("Types", "/participationStatus/ER")
				) {
					nextStatus = controller.getComponentModelProperty("Types", "/participationStatus/C1");
				} else if (currentStatus === controller.getComponentModelProperty("Types", "/participationStatus/A1") || currentStatus ===
					controller.getComponentModelProperty("Types", "/participationStatus/C2")) {
					nextStatus = controller.getComponentModelProperty("Types", "/participationStatus/C2");
				} else if (currentStatus === controller.getComponentModelProperty("Types", "/participationStatus/A2") || currentStatus ===
					controller.getComponentModelProperty("Types", "/participationStatus/C3")) {
					nextStatus = controller.getComponentModelProperty("Types", "/participationStatus/C3");
				}
			}

			controller.updateParticipation(null, nextStatus, null, controller.getTranslation("completeDataSupplierDialogError"),
				function(oData, response) {
					controller.navTo("dataCompletion", {
						id: controller.__partecipationId
					}, true);
				});
			...
			var dialog = new Dialog({
				...
				beginButton: new Button({
					...
					press: function() {
						...
						controller.updateParticipation(dialog, controller.getComponentModelProperty("Types", "/participationStatus/R"), controller.getTranslation(
							"rejectSupplierDialogSuccess"), controller.getTranslation("rejectSupplierDialogError"), function() {
							var oSplitApp = controller.getView().getParent().getParent();
							oSplitApp.setMode(sap.m.SplitAppMode.ShowHideMode);
		...
		__loadTickets: function() {
			...
			var mParameters = {
				...
				success: function(oData) {
					...
					var isCommercialRef = userId === controller.getView().getModel().getProperty("/CommercialRefId");
					var isCommercialMan = userId === controller.getView().getModel().getProperty("/CommercManagerId") || (
						controller.getView().getModel().getProperty("/CommercialRefId") === controller.getView().getModel().getProperty(
							"/CommercManagerId") &&
						doneByFater
					);
					var isSupplier = userRole === controller.getOwnerComponent().getModel("Types").getProperty("/userRoleTypes/SUPPLIER") || (
					...
					// TEST DB 09/05/2017 Forzatura tab Comunicazione visible a scopo di test 
					//oView.byId("communicationTabFilter").setVisible(true);

					var surveyStatus = controller.getView().getModel().getProperty("/Status");
					if (
						(
							isSupplier && (surveyStatus === controller.getComponentModelProperty("Types", "/participationStatus/ES") || surveyStatus ===
								controller.getComponentModelProperty("Types", "/participationStatus/EA")
							)
		...
		getCustomControl: function(bindingContext, enabled) {
			var conditionCanEdit =
				"{= ${user>/Username} === ${SupplierRefId} || ( ${user>/Username} === ${CommercialRefId} &amp;&amp; ${DoneByFater} === true ) }";
		...
		onSaveDraftSupplier: function(oEvent) {
			...
			var dialog = new Dialog({
				...
				beginButton: new Button({
					...
					press: function() {
						controller.updateParticipation(dialog, controller.getComponentModelProperty("Types", "/participationStatus/DQ"),
							controller.getTranslation("saveDraftSupplierDialogSuccess"),
							controller.getTranslation("saveDraftSupplierDialogError"),
							function() {
								var oSplitApp = controller.getView().getParent().getParent();
								oSplitApp.setMode(sap.m.SplitAppMode.ShowHideMode);

								// DB - FIX bug #070: Commentata la navigazione alla lista per
								//                    poter continuare ad elaborare il questionario
								//	controller.navTo("surveyList", {}, true);
							});
					}
				}),
		...
		updateParticipation: function(dialog, newStatus, successMessage, errorMessage, successCallback) {
			...
			if (newStatus === this.getComponentModelProperty("Types", "/participationStatus/ES") || newStatus === this.getComponentModelProperty(
					"Types", "/participationStatus/EA")) {
		...
		__checkRequired: function(field, forceVerificartion) {
			...
			if ((field.required || field.minLength > 0 || (field.options !== null && field.options.validation)) && (!field.skipVerification ||
					forceVerificartion)) {
				...
				if (field.required) {
					...
					// DB - FIX bug #081: Aggiunta validazione per campi tipo Input
					else if (sap.m.Input.getMetadata()._sClassName === element.getMetadata()._sClassName) {
						var value = element.getValue();
						isEmpty = value === "" || value.length === 0;

					} else if (element.getSelectedItem) {
						isEmpty = !element.getSelectedItem() || element.getSelectedItem().getKey() === null || element.getSelectedItem().getKey().length ===
							0;
				...
				if (isValid && element.getValue && element.getValue().length > 0 && field.options !== null && field.options.validation) {
					...
					//FIX DB Validazione specifica per IBAN
					if (field.options.validation.iban) {

						// Opzione 1 - Controllo locale JS
						var ibanValue = element.getValue();
						var isValidIBAN = utils.isValidIBANNumber(ibanValue);
						if (isValidIBAN) {
							isValid = true;
						} else {
							isValid = false;
							...
							if (element.setValueStateText) {
								element.setValueStateText(this.getTranslation("field_iban_error")); //Messaggio generico
							}
						}

						// Opzione 2 - Controllo su SAP (non fattibile perchè ritarda l'esito invalidando il risultato finale della validazione)
						/*						var ibanValue = element.getValue(),
													sPath = "IbanCheck",
													mParameters = {
														urlParameters: {
														...
														success: function(oData, response) {
															if (response.data.CheckControl === true) {
																isValid = true;
															} else {
																isValid = false;
																if (element.setValueState) {
																...
																if (element.setValueStateText) {
																	element.setValueStateText(response.data.Message);
																}
															}
															checkIbanFinished = true;
															//alert("Validazione Iban della CallFunction:" + isValid);
														},
														error: function(oError) {
															element.setValueStateText(this.getTranslation("field_iban_error")); //Messaggio generico
														}
		...
		_validateForm: function() {
			...
			if (element.getSelectedItem()) {
				...
				if (selectedKey === "FAX") {
					...
					if (controller.tabError.fields[controller.__fields["fax"]["name"]] === undefined || valid !== controller.tabError.fields[
							controller.__fields["fax"]["name"]]) {
						if (!valid) {
					...
					if (controller.tabError.fields[controller.__fields["email"]["name"]] === undefined || valid !== controller.tabError.fields[
							controller.__fields["email"]["name"]]) {
						if (!valid) {
			...
			/////////////////////////////////////////////////////////////////
			//FIX DB Validazione specifica per IBAN
			//var isValidIBAN = utils.isValidIBANNumber("TEST");
			//isAllValid = isAllValid && isValidIBAN;
			/////////////////////////////////////////////////////////////////
		...
		isValidIban: function(controller, isAllValid) {
			if (isAllValid === true) {
				var elementIban = controller.getView().byId(controller.__fields["iban"].name);
				var ibanValue = elementIban.getValue(),
					sPath = "IbanCheck",
					mParameters = {
						urlParameters: {
							"IBAN": ibanValue
						...
						success: function(oData, response) {
							if (response.data.CheckControl === true) {
								...
								if (elementIban.setValueState) {
									elementIban.setValueState("Error");
								}
								if (elementIban.setValueStateText) {
									elementIban.setValueStateText(response.data.Message);
								}
								return false;
							}
						},
						error: function(oError) {
							elementIban.setValueStateText(this.getTranslation("field_iban_error")); //Messaggio generico
						}
					};
		...
		onSubmitConfirmPress: function() {
			...
			controller.updateParticipation(null, nextStatus, controller.getTranslation("submitSupplierDialogSuccess"), controller.getTranslation(
				"submitSupplierDialogError"), function() {
				var oSplitApp = controller.getView().getParent().getParent();
				oSplitApp.setMode(sap.m.SplitAppMode.ShowHideMode);
				controller.navTo("surveyList", {}, true);
			});
		...
		__afterValidated: function(isValid) {
			if (isValid) {
				...
				if (isDoneByFater) {
					...
					if (currentStatus === this.getComponentModelProperty("Types", "/participationStatus/DQ") || currentStatus === this.getComponentModelProperty(
							"Types", "/participationStatus/I")) {
						if (!this._submitDialog) {
							this._submitDialog = this.createDialog(this._submitDialog, "org.fater.myinbox.view.fragment.dialogs.SubmitConfirmDialog");
						}
			...
			var dialog = new Dialog({
				...
				content: [
					...
					new Input('explanationRequestTitle', {
						liveChange: function(oEvent) {
							var enabled = sap.ui.getCore().byId("explanationRequestBody").getValue().length > 0 && sap.ui.getCore().byId(
								"explanationRequestTitle").getValue().length > 0;
							oEvent.getSource().getParent().getBeginButton().setEnabled(enabled);
						},
						width: '100%',
				...
				beginButton: new Button({
					...
					press: function() {
						...
						if (userRole === controller.getOwnerComponent().getModel("Types").getProperty("/userRoleTypes/COMMERCIAL_REFERENCE")) {
							...
							if (controller.getView().getModel().getProperty("/DoneByFater") === true && id === controller.getView().getModel().getProperty(
									"/CommercialRefId")) {
								nextStatus = controller.getComponentModelProperty("Types", "/participationStatus/ES");
							} else {
						...
						var oTicket = {
							...
							Item: [{
								ParticipationId: controller.getView().getModel().getProperty("/ParticipationId"),
								Message: sMessage,
								Name: controller.getView().getModel("user").getProperty("/Address/Firstname") + " " + controller.getView().getModel(
									"user").getProperty("/Address/Lastname")
							}]
						};

						controller.getView().getModel("oDataModel").create("/TicketHSet", oTicket, null, function() {
								controller.updateParticipation(dialog, nextStatus, controller.getTranslation(
									"explanationRequestSupplierDialogCreatedSuccess"), controller.getTranslation(
									"explanationRequestSupplierDialogCreatedError"), function() {
									var oSplitApp = controller.getView().getParent().getParent();
									oSplitApp.setMode(sap.m.SplitAppMode.ShowHideMode);
									controller.navTo("surveyList", {}, true);
								});
		...
		onPrintPdfButtonPress: function(oEvent) {
			...
			//FIX DB 25/05/20 - Sostituzione ordine tra selezione tab e stampa
		...
		__printPdf: function(oEvent) {
			...
			// DB - FIX BUG #134 : Valorizzare Titolo pdf con numero Questionario 
			//var	title = model.getProperty("/tabTitle");
			//ar title = this.getTranslation("participationId") + ": " + this.getView().byId("ParticipationId").getText();
			var title = this.getView().byId("ParticipationId").getText();
			...
			html += '<link rel="stylesheet" type="text/css" href="../resources/sap/ui/core/themes/sap_belize/library.css">';
			html += '<link rel="stylesheet" type="text/css" href="../resources/sap/m/themes/sap_belize/library.css">';
			html += '<link rel="stylesheet" type="text/css" href="../resources/sap/ui/layout/themes/sap_belize/library.css">';
			html += '<link rel="stylesheet" type="text/css" href="../resources/sap/ui/unified/themes/sap_belize/library.css">';
			html += '<link rel="stylesheet" type="text/css" href="../resources/sap/ui/commons/themes/sap_belize/library.css">';
		...
		// DB - FIX 15/05/2017: forzatura binding e validazione campi questionario
		_forceChange: function(oEvent) {
			var controller = this;
			var oFieldController = oEvent.getSource();
			oFieldController.onChange(oEvent);

			// NOTA:
			// Aggiunto attributo liveChange="_forceChange" agli elementi di tipo Input nei fragment:
			//	•	IdentifyRecord
			//	•	FinancialData
			//	•	OrganizationContact

			//Validazione E-mail o fax in base a Mod. Comun. Std. scelto 
			if ((oFieldController.sId.search("fax") > 0) || oFieldController.sId.search("email") > 0) {

				var element = controller.getView().byId("communication_preferred");
				if (element.getSelectedItem()) {
					var selectedKey = element.getSelectedItem().getKey();
					if (selectedKey === "FAX") {
						var valid = controller.__checkRequired(controller.__fields["fax"], true);
			...
			// Validazione Contact Business Email (contact_business_email)
			if (oFieldController.sId.search("contact_business_email") > 0) {
				controller.__checkRequired(controller.__fields["contact_business_email"], true);
			}
		},
		...
		_resetValidation: function() {
			...
			for (var key in that.tabError.groups) {
				if (that.tabError.groups.hasOwnProperty(key)) {
					that.getView().byId("survey_group_" + key).setCount(null);
					that.getView().byId("survey_group_" + key).setIconColor("Default");
				}
			}

			// Reset Campi 
			for (var key in that.__fields) {
				var field = that.__fields[key];
				if (that.__fields.hasOwnProperty(key)) {
					var element = that.getView().byId(field.name);
