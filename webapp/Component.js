sap.ui.define([
	"org/fater/myinbox/framework/Component",
	"sap/ui/Device",
	"org/fater/myinbox/model/models",
	"sap/ui/model/json/JSONModel"
	
], function(UIComponent, Device, models, JSONModel) {
	"use strict";

	return UIComponent.extend("org.fater.myinbox.Component", {
		metadata: {
			manifest: "json"
		},
		...
		afterInit: function() {
			var rootPath = jQuery.sap.getModulePath("org.fater.myinbox");
